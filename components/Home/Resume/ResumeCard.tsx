...
const ResumeCard = ({ role, Icon, date, company, description }: Props) => {
  return (
    <div className="mb-6">
      <div className="flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md">
        ...
        <div className="flex-1">
          ...
          <p className="text-cyan-300 text-xl mt-1 font-medium">{company}</p>

          <ul className="text-gray-300 text-sm sm:text-base pt-3 space-y-2 list-disc pl-5">
